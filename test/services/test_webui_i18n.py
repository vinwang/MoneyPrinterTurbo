...
ENGLISH_FALLBACK_KEYS = frozenset(
    {
        "Enable E-commerce Template",
        "E-commerce Template Settings",
        "Category Preset",
        "Food / Agriculture",
        "Beauty",
        ...
        "Visual Requirement",
        "Seconds",
        "Screenshot Layers JSON (Optional)",
        "Screenshot layer fields and managed resource path help.",
        "Invalid Screenshot Layers JSON",
        "Screenshot Layers JSON Must Be An Array",
        "Add Specified Text",
        "Advertising Output Profile",
        "Advertising Output Profile Help",
        "Advertising Profile Portrait Test",
        "Advertising Profile Portrait",
        "Advertising Profile Landscape",
        "Advertising Profile Square",
        "Advertising Post-processing",
        "Advertising Post-processing Help",
        "Enable Advertising Post-processing",
        "Enable Logo Watermark",
        "Invalid Advertising Post-processing",
        "Final Advertising Video Preview",
        "Final Advertising Video Preview Help",
        "Invalid Logo",
        "Selected Logo",
        "Specified Text",
        "Specified Text Style",
        "Specified Text Layout and Animation",
        "Specified Text Content",
        "Text Animation",
        "Text Color",
        "Text End",
        "Text Flicker Duration",
        "Text Flicker Frequency",
        "Text Flicker Scale",
        "Text Font",
        "Text Font Size",
        "Text Initial Scale",
        "Specified Text Font Does Not Support Text",
        "Text Pop Duration",
        "Text Pop Spring",
        "Text Stagger",
        "Text Start",
        ...
        "Image Height Ratio",
        "Image Opacity",
        "Trim Transparent Logo Border",
        "Trim Transparent Logo Border Help",
        "Upload Logo",
        "Upload Logo Help",
        ...
        "Storyboard Auto Selected",
        "Show Storyboard Video Preview",
        "Storyboard Shot",
        "Local Asset Unavailable",
        "Enter Script to Match Local Materials",
        "Configure Local Asset Library",
        "Local Asset Library Configuration Invalid",
        "Local Asset Library",
        "Local Asset Library Help",
        "Local Video Library Directory",
        "Local BGM Library Directory",
        "Update Local Asset Index",
        "Updating Local Asset Index",
        "Local Asset Index Updated",
        "Local Asset Index Failed",
        "Local Asset Index Warning",
        "Local Storyboard Match Failed",
        "Local Storyboard Order Locked",
        "Add Uploaded Materials to Library",
        "Add Uploaded Materials to Library Help",
        "Uploaded Material Library Category",
        "Smart Local Background Music",
        "Smart Local Background Music Candidate",
        "No Local BGM Available",
        "Please Select Local Background Music",
        "Local BGM Preparation Failed",
        "Local Material Import Failed",
        "Local Asset Usage Record Failed",
        "Storyboard Gap Needs Material",
        "Fill Storyboard Gap",
        "Storyboard Gap Unfilled",
        "Storyboard Gaps Need Material",
        "Asset Annotation",
        "Asset Annotation Help",
        "Annotate Asset",
        "Auto Analysis Description",
        "Auto Analysis Tags",
        "Manual Description",
        "Manual Description Help",
        "Manual Tags",
        "Manual Tags Help",
        "Save Asset Annotation",
        "Asset Annotation Saved",
        "Asset Annotation Failed",
        "No Indexed Asset To Annotate",
